    ...
    return Shortcuts(
      shortcuts: {
        SingleActivator(
          ...
          _model.appset = await queryAppSettingsRecordOnce(
          ...
          if (functions
              ...
              .isNotEmpty) {
            if (_model.appset!.settingList
                .where((e) => e.title == 'settledBtndisable')
                .toList()
                .firstOrNull!
                .value) {
                ...
                builder: (context) {
                  return GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: PaymentModeGroceryPrintWidget(
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      safeSetState(
                                                                        ...
                                                                        _model
                                                                            ...
                                                                            ?.text = containerVarItem.name;
                                                                      });
                                                                      safeSetState(
                                                                          () {
                                                                        _model
                                                                            .custmobTextController
                                                                            ?.text = containerVarItem.mobile;
                                                                      });
                                                                      Navigator.pop(
                                                                          context);
                                                                    },
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  if (containerVarItem.oldBalance > 0)
                                                                                    Flexible(
                                                                                      child: Padding(
                        ...
                        body: StreamBuilder<List<AppSettingsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<AppSettingsRecord>
                                containerAppSettingsRecordList = snapshot.data!;
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  if (_model.submenureport)
                                    Align(
                                      alignment:
                                          AlignmentDirectional(-0.15, -0.79),
                                      child: Container(
                                        width: 240.0,
                                        height: 160.0,
                                        decoration: BoxDecoration(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'muf0hdo2' /* Customer Ledger Report */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
