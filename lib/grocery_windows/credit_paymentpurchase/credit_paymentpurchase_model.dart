...
import 'credit_paymentpurchase_widget.dart' show CreditPaymentpurchaseWidget;
...
class CreditPaymentpurchaseModel
    extends FlutterFlowModel<CreditPaymentpurchaseWidget> {
  ///  Local state fields for this page.

  List<PurchaseSaleItemListStruct> listprd = [];
  void addToListprd(PurchaseSaleItemListStruct item) => listprd.add(item);
  void removeFromListprd(PurchaseSaleItemListStruct item) =>
      listprd.remove(item);
  void removeAtIndexFromListprd(int index) => listprd.removeAt(index);
  void insertAtIndexInListprd(int index, PurchaseSaleItemListStruct item) =>
