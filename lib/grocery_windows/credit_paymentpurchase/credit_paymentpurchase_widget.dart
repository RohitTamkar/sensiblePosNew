...
import 'credit_paymentpurchase_model.dart';
export 'credit_paymentpurchase_model.dart';
...
class _CreditPaymentpurchaseWidgetState
    extends State<CreditPaymentpurchaseWidget> {
  late CreditPaymentpurchaseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreditPaymentpurchaseModel());
