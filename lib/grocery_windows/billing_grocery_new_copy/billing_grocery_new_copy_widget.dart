                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child:
                                                                GroceryWidget(
                                                              key: Key(
                                                                  'Keyy2c_${prdlistIndex}_of_${prdlist.length}'),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'qy5oh16c' /* Customer Ledger Report */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
