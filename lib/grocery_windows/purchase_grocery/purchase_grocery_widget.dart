...
import 'purchase_grocery_model.dart';
export 'purchase_grocery_model.dart';

class PurchaseGroceryWidget extends StatefulWidget {
  const PurchaseGroceryWidget({super.key});

  @override
  State<PurchaseGroceryWidget> createState() => _PurchaseGroceryWidgetState();
}

class _PurchaseGroceryWidgetState extends State<PurchaseGroceryWidget> {
  late PurchaseGroceryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PurchaseGroceryModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          ...
          _model.textController14?.text = FFLocalizations.of(context).getText(
            'x8zzfwmd' /* 150 */,
          );
        }));
  }
