                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onFieldSubmitted:
                                                                      ...
                                                                      safeSetState(
                                                                          () {
                                                                        _model.textFielddisamtTextController?.text = FFAppState()
                                                                            .disAmtPay
                                                                            .toString();
                                                                      });
                                                                    },
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  var _shouldSetState = false;
                                                  _model.resultprint = await actions
                                                      .calculateGroceryAmtaction(
                                                    FFAppState().PayMode,
                                                    valueOrDefault<double>(
                                                      FFAppState().finalAmt,
                                                  ...
                                                  if (FFAppState().finalAmt ==
                                                    ...
                                                    await _model
                                                        .invonlineprt!.reference
                                                        .update(
                                                            createInvoiceRecordData(
                                                      id: _model.invonlineprt
                                                          ?.reference.id,
                                                    ));
                                                                ...
                                                                (productRecord) =>
                                                                    productRecord
                                                                        .where(
                                                                          'id',
                                                                          isEqualTo:
                                                                              (_model.prdlinstnewtx?.elementAtOrNull(FFAppState().startLoop))?.id,
                                                                        )
                                                                        .where(
                                                                          'stockable',
                                                                          isEqualTo:
