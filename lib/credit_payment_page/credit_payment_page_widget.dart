...
class _CreditPaymentPageWidgetState extends State<CreditPaymentPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().months = functions
          .returnmonthjson(
              '[    {\"month\": \"January\", \"number\": 1},    {\"month\": \"February\", \"number\": 2},    {\"month\": \"March\", \"number\": 3},    {\"month\": \"April\", \"number\": 4},    {\"month\": \"May\", \"number\": 5},    {\"month\": \"June\", \"number\": 6},    {\"month\": \"July\", \"number\": 7},    {\"month\": \"August\", \"number\": 8},    {\"month\": \"September\", \"number\": 9},    {\"month\": \"October\", \"number\": 10},    {\"month\": \"November\", \"number\": 11},    {\"month\": \"December\", \"number\": 12}]')
          .toList()
          .cast<dynamic>();
      setState(() {});
    });
                                  ...
                                  child: StreamBuilder<List<InvoiceRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<InvoiceRecord>
                                          ...
                                          snapshot.data!;
                                      if (listViewInvoiceRecordList.isEmpty) {
                                        return Center(
                                          child: Image.asset(
                                  ...
                                  child: StreamBuilder<List<PaymentRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<PaymentRecord>
                                          ...
                                          snapshot.data!;
                                      if (listViewPaymentRecordList.isEmpty) {
                                        return Center(
                                          child: Image.asset(
                                            'assets/images/Sensible_Connect_Logo_1.png',
                                          ),
                                      ...
                                      return ListView.builder(
                                        ...
                                        scrollDirection: Axis.vertical,
                                        itemCount:
                                            listViewPaymentRecordList.length,
                                        itemBuilder: (context, listViewIndex) {
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                        ...
                                                                        dateTimeFormat(
                                                                          "yMMMd",
                                                                          DateTime.fromMillisecondsSinceEpoch(
                                                                              listViewPaymentRecord.createdDate),
                                                                          locale:
