                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return FFButtonWidget(
                                                                        onPressed:
                                                                          ...
                                                                          _shouldSetState =
                                                                              true;
                                                                          _model.shiftdetailhive =
                                                                              await actions.hiveGetShiftDetails();
                                                                          _shouldSetState =
                                                                              true;
                                ...
                                StreamBuilder<List<OutletRecord>>(
                                  stream: queryOutletRecord(
                                    queryBuilder: (outletRecord) =>
                                      ...
                                      isEqualTo: containerDeviceRecord
                                                  ?.outletRef?.id !=
                                              ''
                                          ? containerDeviceRecord?.outletRef?.id
                                          : null,
                                    ),
                                    singleRecord: true,
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    final subscriptionOutletRecord =
                                        subscriptionOutletRecordList.isNotEmpty
                                            ? subscriptionOutletRecordList.first
                                            : null;
