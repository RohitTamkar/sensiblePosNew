...
import 'ims_production_model.dart';
export 'ims_production_model.dart';
...
class _ImsProductionWidgetState extends State<ImsProductionWidget>
    with TickerProviderStateMixin {
  late ImsProductionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImsProductionModel());
