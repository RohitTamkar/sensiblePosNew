...
import '/index.dart';
import 'table_list_mobile_widget.dart' show TableListMobileWidget;
...
class TableListMobileModel extends FlutterFlowModel<TableListMobileWidget> {
  ...
  // Stores action output result for [Custom Action - getProductlistHive] action in TableListMobile widget.
  List<ProductStructStruct>? hiveProductList;
  // Stores action output result for [Custom Action - getCategorylistHive] action in TableListMobile widget.
  List<CategoryStructStruct>? categoryListHive;
  // Stores action output result for [Firestore Query - Query a collection] action in TableListMobile widget.
  List<PremisesRecord>? premiseDoc;
  // Stores action output result for [Custom Action - scanPrinter] action in TableListMobile widget.
  bool? resDevice2Copy;
  // Stores action output result for [Custom Action - connectDevice] action in TableListMobile widget.
  bool? isConnected;
