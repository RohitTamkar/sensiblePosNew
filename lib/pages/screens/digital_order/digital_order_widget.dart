...
import 'digital_order_model.dart';
export 'digital_order_model.dart';
...
class _DigitalOrderWidgetState extends State<DigitalOrderWidget> {
  late DigitalOrderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DigitalOrderModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.instantTimer = InstantTimer.periodic(
        ...
        callback: (timer) async {
          _model.res = await actions.getDigitalOrders();
          if (_model.res!) {
            await showDialog(
              context: context,
              builder: (alertDialogContext) {
                return AlertDialog(
                  title: Text('function hit'),
                  actions: [
                    TextButton(
            ...
            body: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<List<OnlineOrdersRecord>>(
                      stream: queryOnlineOrdersRecord(
                        queryBuilder: (onlineOrdersRecord) =>
                            onlineOrdersRecord.where(
                          'status',
                          isEqualTo: FFAppState().digitalStatus != ''
                              ? FFAppState().digitalStatus
                              : null,
                        ),
                      ),
                      builder: (context, snapshot) {
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Builder(
                                                      builder: (context) {
                                                        final list =
                                                            containerOnlineOrdersRecordList
                                                                .toList();
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '7r31iqye' /* Delivery Person Details */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
