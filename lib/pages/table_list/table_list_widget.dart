                                                            ...
                                                            Flexible(
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  _model.tkot =
                                                                      await TableKotRecord.getDocumentOnce(
                                                                          FFAppState()
                                                                              .kotDocRef!);
                                                                  if (_model
                                                                          .tkot !=
                                                                                                    ...
                                                                                                    Padding(
                                                                                                      ...
                                                                                                      child: Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          KotremarkWidget(
                                                                                                            key: Key('Keyz9j_${billIndex}_of_${bill.length}'),
                                                                                                            parameter1: billItem,
                                                                                                          ),
                                                                                                        ],
                                                                                                      ),
                                                                    ...
                                                                    child: Row(
                                                                      mainAxisSize:
                                                                          MainAxisSize
                                                                              .max,
                                                                      children: [
                                                                        if (tableListAppSettingsRecord?.settingList?.where((e) => e.title == 'enableCustomer').toList()?.firstOrNull?.value ??
                                                                            true)
                                                                          Expanded(
                                                                            flex:
                                                                                11,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              if (animationsMap['containerOnActionTriggerAnimation4'] != null) {
                                                                                ...
                                                                                SchedulerBinding.instance.addPostFrameCallback((_) async => await animationsMap['containerOnActionTriggerAnimation4']!.controller.forward(from: 0.0));
                                                                              }
                                                                            },
                                                                            child:
                                                                                Container(
                                                                              width: MediaQuery.sizeOf(context).width * 0.032,
                                                                              height: MediaQuery.sizeOf(context).width * 0.032,
                                                                              decoration: BoxDecoration(
                                                                                shape: BoxShape.circle,
                                                                                border: Border.all(
                                                                                  color: FlutterFlowTheme.of(context).lineColor,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: FlutterFlowDropDown<String>(
                                                                                ...
                                                                                options: FFAppState().paymentmodenew,
                                                                                onChanged: (val) async {
                                                                                ...
                                                                                borderWidth: 0.0,
                                                                                borderRadius: 0.0,
                                                                                margin: EdgeInsetsDirectional.fromSTEB(7.0, 4.0, 5.0, 4.0),
                                                                                hidesUnderline: true,
                                                                                isSearchable: false,
                                                                                isMultiSelect: false,
                                                                              ),
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            if (animationsMap['containerOnActionTriggerAnimation6'] !=
                                                                              ...
                                                                              SchedulerBinding.instance.addPostFrameCallback((_) async => await animationsMap['containerOnActionTriggerAnimation6']!.controller.forward(from: 0.0));
                                                                            }
                                                                          },
                                                                          child:
                                                                              Container(
                                                                        ...
                                                                        ).animateOnActionTrigger(animationsMap['containerOnActionTriggerAnimation6']!,
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              var _shouldSetState = false;
                                                                              if (functions.filterBillList(FFAppState().selBill, FFAppState().allBillsList.toList()).length > 0) {
                                                                                _model.prdlistsavebillupi = await actions.filterProductsKot(
                                                                                  FFAppState().selBill,
                                                                                  FFAppState().allBillsList.toList(),
                                                                                  false,
                                                                                );
                                                                                _shouldSetState = true;
                                                                                _model.internetconCopy = await actions.checkInternetConnection();
                                                                                _shouldSetState = true;
                                                                        ...
                                                                        ).animateOnActionTrigger(animationsMap['containerOnActionTriggerAnimation7']!,
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              var _shouldSetState = false;
                                                                              if (functions.filterBillList(FFAppState().selBill, FFAppState().allBillsList.toList()).length > 0) {
                                                                                _model.prdlistsavebillkotCopy = await actions.filterProductsKot(
                                                                                  FFAppState().selBill,
                                                                                  FFAppState().allBillsList.toList(),
                                                                                  true,
                                                                                );
                                                                                _shouldSetState = true;
                                                                                _model.internetconkotCopy = await actions.checkInternetConnection();
                                                                                _shouldSetState = true;
                                                                                if (_model.internetconkotCopy!) {
                                                                                  if (FFAppState().kotDocRef != null) {
                                                                                    await FFAppState().kotDocRef!.update({
                                                                                      ...createTableKotRecordData(
                                                                                        finalBillAmt: FFAppState().finalAmt,
                                                                                    ...
                                                                                    _model.kotCopyCopy = TableKotRecord.getDocumentFromData({
                                                                                      ...createTableKotRecordData(
                                                                                        dayId: functions.getDayId(),
                                                                                        createdDate: getCurrentTimestamp.millisecondsSinceEpoch,
                                                                                        checkInTime: getCurrentTimestamp.millisecondsSinceEpoch,
                                                                                    ...
                                                                                    await _model.kotCopyCopy!.reference.update(createTableKotRecordData(
                                                                                      id: _model.kotCopyCopy?.reference.id,
                                                                                    ));
                                                                                  }
                                                                                } else {
                                                                                  await showDialog(
                                                                        ...
                                                                        ).animateOnActionTrigger(animationsMap['containerOnActionTriggerAnimation8']!,
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          if (animationsMap['containerOnActionTriggerAnimation9'] !=
                                                                              null) {
                                                                            safeSetState(() =>
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onPressed: () async {
                                                                                var _shouldSetState = false;
                                                                                if (functions.filterBillList(FFAppState().selBill, FFAppState().allBillsList.toList()).length > 0) {
                                                                                  _model.prdlistsavebillupiCopy = await actions.filterProductsKot(
                                                                                    FFAppState().selBill,
                                                                                    FFAppState().allBillsList.toList(),
                                                                                    false,
                                                                                  );
                                                                                  _shouldSetState = true;
                                                                                  _model.internetconCopyCopy = await actions.checkInternetConnection();
                                                                                  _shouldSetState = true;
                                                                                  if (_model.internetconCopyCopy!) {
                                                                                    if (FFAppState().kotDocRef != null) {
                                                                                      await FFAppState().kotDocRef!.update({
                                                                                        ...createTableKotRecordData(
                                                                                          finalBillAmt: FFAppState().finalAmt,
                                                                                      ...
                                                                                      _model.kotCopy2 = TableKotRecord.getDocumentFromData({
                                                                                        ...createTableKotRecordData(
                                                                                          dayId: functions.getDayId(),
                                                                                          createdDate: getCurrentTimestamp.millisecondsSinceEpoch,
                                                                                          checkInTime: getCurrentTimestamp.millisecondsSinceEpoch,
                                                                                      ...
                                                                                      FFAppState().kotDocRef = _model.kotCopy?.reference;
                                                                                      safeSetState(() {});
                                                                                    }

                                                                                    _model.tablekotCopy = await queryTableKotRecordOnce(
                                                                                      parent: FFAppState().outletIdRef,
                                                                                      queryBuilder: (tableKotRecord) => tableKotRecord.where(
                                                                                        'id',
                                                                                        isEqualTo: FFAppState().kotDocRef?.id,
                                                                                    ...
                                                                                    _shouldSetState = true;
                                                                                    _model.returnedListkotCopy = await actions.selectBillPrint(
                                                                                      FFAppState().selBill.toString(),
                                                                                      FFAppState().allBillsList.toList(),
                                                                                    );
                                                                                    _shouldSetState = true;
                                                                                    _model.devicekotCopy = await actions.newCustomAction(
                                                                                      FFAppState().printerIndex,
                                                                                    );
                                                                                    _shouldSetState = true;
                                                                                    _model.spoutletkotCopy = await queryServicePointOutletRecordOnce(
                                                                                      parent: FFAppState().outletIdRef,
                                                                                    );
                                                                                    _shouldSetState = true;
                                                                                    await actions.printBilltable(
                                                                                      _model.returnedListkotCopy!.toList(),
                                                                                      _model.devicekotCopy!.toList(),
                                                                                      FFAppState().isPrinterConnected,
                                                                                      FFAppState().printerName,
                                                                                      _model.tablekotCopy!,
                                                                                      FFAppState().paperSize,
                                                                                    ...
                                                                                    _model.prdlistsavebillkotupdateCopy = await actions.filterProductsKot(
                                                                                      FFAppState().selBill,
                                                                                      FFAppState().allBillsList.toList(),
                                                                                      true,
                                                                                    );
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Visibility(
                                                                            visible:
                                                                                tableListAppSettingsRecord?.settingList?.where((e) => e.title == 'enableSaveBill').toList()?.firstOrNull?.value ?? true,
                                                                            child:
                                                                                FFButtonWidget(
                                                                              onPressed: () async {
                                                                                var _shouldSetState = false;
                                                                              ...
                                                                              text: FFLocalizations.of(context).getText(
                                                                                'l5p8byv1' /* Settled & Save Bill */,
                                                                              ),
                                                                              options: FFButtonOptions(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 0.0),
                                                                                iconPadding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 0.0),
                                                                                color: Color(0xFFB60042),
