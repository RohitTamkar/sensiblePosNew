                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      if (tableListAppSettingsRecord
                                                                              ?.settingList
                                                                              ?.where((e) => e.title == 'enableCustomer')
                                                                              .toList()
                                                                              ?.firstOrNull
                                                                              ?.value ??
                                                                          true)
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        ).animateOnActionTrigger(animationsMap['containerOnActionTriggerAnimation4']!,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            if (functions.filterBillList(FFAppState().selBill, FFAppState().allBillsList.toList()).length >
                                                                              ...
                                                                              _model.prdlistsavebillupi = await actions.filterProducts2(
                                                                                FFAppState().selBill,
                                                                                FFAppState().allBillsList.toList(),
                                                                              );
                                                                              _shouldSetState = true;
                                                                              ...
                                                                              if (_model.internetconCopy!) {
                                                                                ...
                                                                                _model.hiveInvoiceDataupi = await actions.addInvoiceBillhive(
                                                                              ...
                                                                              if (getJsonField(
                                                                                ...
                                                                                _model.shiftSummarResultsNew2Copy = await actions.calShiftSummaryNew(
                                                                                  _model.hiveInvoiceDataupi!,
                                                                                  FFAppState().shiftDetailsJson,
                                                                                );
                                                                                _shouldSetState = true;
                                                                                _model.shiftidhive2Copy = await actions.shiftIdtoInt(
                                                                                  getJsonField(
                                                                                    FFAppState().shiftDetailsJson,
                                                                                    r'''$.shiftId''',
                                                                                  ).toString(),
                                                                                ...
                                                                                _shouldSetState = true;
                                                                                _model.getOfflineShiftdetailsCopy = await actions.hiveShiftCrud(
                                                                                ...
                                                                                FFAppState().count = _model.updatedShift23Copy!.billCount;
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (animationsMap['containerOnActionTriggerAnimation9'] !=
                                                                          ...
                                                                          SchedulerBinding
                                                                              .instance
                                                                              .addPostFrameCallback((_) async => await animationsMap['containerOnActionTriggerAnimation9']!.controller.forward(from: 0.0));
                                                                        }
                                                                      },
                                                                      child:
                                                                          ClipRRect(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              final buttonOutletRecord = snapshot.data!;
