...
import 'customer_ledgerreport_model.dart';
export 'customer_ledgerreport_model.dart';
...
class _CustomerLedgerreportWidgetState
    extends State<CustomerLedgerreportWidget> {
  late CustomerLedgerreportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerLedgerreportModel());
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            paymentItem.oldBalance.toString(),
                                                                            textAlign:
                                                                                TextAlign.center,
