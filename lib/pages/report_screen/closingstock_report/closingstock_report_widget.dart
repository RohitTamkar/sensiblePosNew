...
import 'closingstock_report_model.dart';
export 'closingstock_report_model.dart';

class ClosingstockReportWidget extends StatefulWidget {
  const ClosingstockReportWidget({super.key});

  static String routeName = 'closingstockReport';
  static String routePath = 'closingstockReport';

  @override
  State<ClosingstockReportWidget> createState() =>
      _ClosingstockReportWidgetState();
}

class _ClosingstockReportWidgetState extends State<ClosingstockReportWidget>
    with TickerProviderStateMixin {
  late ClosingstockReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClosingstockReportModel());
