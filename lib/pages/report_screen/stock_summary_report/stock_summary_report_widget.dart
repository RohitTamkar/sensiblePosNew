...
import 'stock_summary_report_model.dart';
export 'stock_summary_report_model.dart';

class StockSummaryReportWidget extends StatefulWidget {
  const StockSummaryReportWidget({super.key});

  static String routeName = 'stockSummaryReport';
  static String routePath = 'stockSummaryReport';

  @override
  State<StockSummaryReportWidget> createState() =>
      _StockSummaryReportWidgetState();
}

class _StockSummaryReportWidgetState extends State<StockSummaryReportWidget>
    with TickerProviderStateMixin {
  late StockSummaryReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockSummaryReportModel());
