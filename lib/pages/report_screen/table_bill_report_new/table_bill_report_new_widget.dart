...
import 'table_bill_report_new_model.dart';
export 'table_bill_report_new_model.dart';

class TableBillReportNewWidget extends StatefulWidget {
  const TableBillReportNewWidget({super.key});

  static String routeName = 'tableBillReportNew';
  static String routePath = 'tableBillReportNew';

  @override
  State<TableBillReportNewWidget> createState() =>
      _TableBillReportNewWidgetState();
}

class _TableBillReportNewWidgetState extends State<TableBillReportNewWidget>
    with TickerProviderStateMixin {
  late TableBillReportNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TableBillReportNewModel());
