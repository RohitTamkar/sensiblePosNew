...
import 'subscription_new_model.dart';
export 'subscription_new_model.dart';
...
class _SubscriptionNewWidgetState extends State<SubscriptionNewWidget> {
  late SubscriptionNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubscriptionNewModel());
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'pye5jn76' /* Founded in 2016, Sensible Conn... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'w1pihp54' /* These are widely acknowledged ... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'vw8c0s4r' /* To use the service provided by... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'woi1qxk4' /* When you purchase a subscripti... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'rmo895wy' /* Standard product warranty is f... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                    ...
                                    return Material(
                                      ...
                                      child: Container(
                                        ...
                                        child: StreamBuilder<
                                          ...
                                          stream:
                                              BusinesssMasterRecord.getDocument(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'lgwk3f2m' /* Sensible Connect Solutions Pvt... */,
                                                              ),
