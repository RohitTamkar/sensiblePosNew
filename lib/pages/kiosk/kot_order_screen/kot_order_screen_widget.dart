...
class _KotOrderScreenWidgetState extends State<KotOrderScreenWidget>
  ...
  void initState() {
    ...
    _model.textFielddrawerTextController ??= TextEditingController();
    _model.textFielddrawerFocusNode ??= FocusNode();
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.textFielddrawerTextController,
                                    focusNode: _model.textFielddrawerFocusNode,
                                    onChanged: (_) => EasyDebounce.debounce(
                                      '_model.textFielddrawerTextController',
                                      Duration(milliseconds: 2000),
                                      () async {
                                        if (_model.textFielddrawerTextController
                                                    .text !=
                                                null &&
                                            _model.textFielddrawerTextController
                                                    .text !=
