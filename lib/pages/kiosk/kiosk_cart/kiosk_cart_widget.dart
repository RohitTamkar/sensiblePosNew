...
import '/pages/kiosk/dineinparcel/dineinparcel_widget.dart';
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            DineinparcelWidget(
                                                                              key: Key('Keyqut_${listviewIndex}_of_${listview.length}'),
                                                                              ordertype: getJsonField(
                                                                                listviewItem,
                                                                                r'''$.ordertype''',
                                                                              ),
                                                                              inclusivetax: valueOrDefault<bool>(
                                                                                widget!.appsetting?.settingList?.where((e) => e.title == 'enableInclusiveTax').toList()?.firstOrNull?.value,
                                                                                false,
                                                                              ),
