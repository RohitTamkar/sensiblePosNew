...
import 'edit_userprofile_model.dart';
export 'edit_userprofile_model.dart';
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                AutoSizeText(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'tocdecfi' /* Quick PIN (4 Digit Only) */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .titleSmall
                                                              ...
                                                              children: [
                                                                Text(
                                                                  FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'y2iin2wz' /* View User settings and access */,
                                                                  ),
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodySmall
