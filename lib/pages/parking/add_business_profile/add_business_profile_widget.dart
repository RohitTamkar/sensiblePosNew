...
import 'add_business_profile_model.dart';
export 'add_business_profile_model.dart';

class AddBusinessProfileWidget extends StatefulWidget {
  const AddBusinessProfileWidget({
    super.key,
    this.premiseRef,
    this.mobile,
  });
  ...
  State<AddBusinessProfileWidget> createState() =>
      _AddBusinessProfileWidgetState();
}

class _AddBusinessProfileWidgetState extends State<AddBusinessProfileWidget> {
  late AddBusinessProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddBusinessProfileModel());
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'j62rbs8a' /* Business Details Form */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                                          .override(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.textBusinessNameFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'ougutd12' /* Business Name */,
                                      ),
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (_model.textBusinessNameTextController
                                              ...
                                              _model.textBusinessNameTextController
                                                      .text !=
                                                  '') {
                                            if (_model.dropDownBusinessTypeValue !=
                                                    null &&
                                                _model.dropDownBusinessTypeValue !=
                                                    '') {
                                              _model.busineesTypeDoc =
                                                  await queryBusinessTypeRecordOnce(
                                                queryBuilder:
                                                    (businessTypeRecord) =>
                                                        businessTypeRecord
                                                            .where(
                                              ...
                                              var businesssMasterRecordReference =
                                                  BusinesssMasterRecord
                                                      .collection
                                                      .doc();
                                              await businesssMasterRecordReference
                                                  .set(
                                              ...
                                              _model.doc = BusinesssMasterRecord
                                                  .getDocumentFromData(
                                                      createBusinesssMasterRecordData(
                                                        name: functions
                                                            .toCapitalLetter1(_model
                                                      ...
                                                      businesssMasterRecordReference);
                                              _shouldSetState = true;

                                              await _model.doc!.reference.update(
                                                  createBusinesssMasterRecordData(
                                              ...
                                              await showDialog(
                                                ...
                                                builder: (alertDialogContext) {
                                                  return AlertDialog(
                                                    title: Text('Create'),
                                                    content: Text(
                                                        'Business Details Form is Created'),
                                                    actions: [
                                                      TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Business Type'),
                                                            content: Text(
                                                                'Pleas Enter Your Business Type'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text(
                                                              'Validation Failed'),
                                                          content: Text(
                                                              'Pleas enter your business name'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
