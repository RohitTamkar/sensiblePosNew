...
import 'create_user_profile_new_p_model.dart';
export 'create_user_profile_new_p_model.dart';

class CreateUserProfileNewPWidget extends StatefulWidget {
  ...
  State<CreateUserProfileNewPWidget> createState() =>
      _CreateUserProfileNewPWidgetState();
}

class _CreateUserProfileNewPWidgetState
    extends State<CreateUserProfileNewPWidget> {
  late CreateUserProfileNewPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateUserProfileNewPModel());
    ...
    _model.pwdTextFieldTextController ??= TextEditingController();
    _model.pwdTextFieldFocusNode ??= FocusNode();
                                            ...
                                            Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  validator: _model
                                                      .pwdTextFieldTextControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
