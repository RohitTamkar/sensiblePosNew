...
import 'ims_inward_outward_model.dart';
export 'ims_inward_outward_model.dart';
...
class _ImsInwardOutwardWidgetState extends State<ImsInwardOutwardWidget>
    with TickerProviderStateMixin {
  late ImsInwardOutwardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImsInwardOutwardModel());
