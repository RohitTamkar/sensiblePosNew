...
import 'full_screen_q_r_model.dart';
export 'full_screen_q_r_model.dart';
...
class _FullScreenQRWidgetState extends State<FullScreenQRWidget> {
  late FullScreenQRModel _model;
