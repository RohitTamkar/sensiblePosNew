...
import 'ims_service_model.dart';
export 'ims_service_model.dart';
...
class _ImsServiceWidgetState extends State<ImsServiceWidget>
    with TickerProviderStateMixin {
  late ImsServiceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImsServiceModel());
