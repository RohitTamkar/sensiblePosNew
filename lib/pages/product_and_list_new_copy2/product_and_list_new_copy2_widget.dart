...
import 'product_and_list_new_copy2_model.dart';
export 'product_and_list_new_copy2_model.dart';

class ProductAndListNewCopy2Widget extends StatefulWidget {
  const ProductAndListNewCopy2Widget({
    super.key,
    this.billDetails,
    this.doc,
    this.shiftDetails,
  ...
  static String routeName = 'ProductAndListNewCopy2';
  static String routePath = 'productAndListNewCopy2';

  @override
  State<ProductAndListNewCopy2Widget> createState() =>
      _ProductAndListNewCopy2WidgetState();
}

class _ProductAndListNewCopy2WidgetState
    extends State<ProductAndListNewCopy2Widget> with TickerProviderStateMixin {
  late ProductAndListNewCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductAndListNewCopy2Model());
            ...
            child: StreamBuilder<List<AppSettingsRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<AppSettingsRecord>
                    productAndListNewCopy2AppSettingsRecordList =
                    snapshot.data!;
                // Return an empty Container when the item does not exist.
                if (snapshot.data!.isEmpty) {
                  return Container();
                }
                final productAndListNewCopy2AppSettingsRecord =
                    productAndListNewCopy2AppSettingsRecordList.isNotEmpty
                        ? productAndListNewCopy2AppSettingsRecordList.first
                        : null;

                return Title(
                    title: 'ProductAndListNewCopy2',
                            ...
                            child: Drawer(
                              ...
                              child: wrapWithModel(
                                ...
                                child: MenuDrawerWidget(
                                  ...
                                  appSettings23:
                                      productAndListNewCopy2AppSettingsRecord,
                                ),
                              ),
                            ),
                          ),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      if (productAndListNewCopy2AppSettingsRecord
                                                              ?.settingList
                                                              ?.where((e) =>
                                                                  e.title ==
                                                                  'enableLedDisplay')
                                                                            ...
                                                                            Expanded(
                                                                              child: Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: Builder(
                                                                                    builder: (context) {
                                                                                      final categoryList = (productAndListNewCopy2AppSettingsRecord!.settingList.where((e) => e.title == 'sortCategoryByCode').toList().firstOrNull!.value ? FFAppState().categoryHive.sortedList(keyOf: (e) => e.code, desc: false) : FFAppState().categoryHive.sortedList(keyOf: (e) => e.name, desc: false)).toList();
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Builder(
                                                                                  builder: (context) {
                                                                                    final productList = (productAndListNewCopy2AppSettingsRecord!.settingList.where((e) => e.title == 'sortProductByCode').toList().firstOrNull!.value ? FFAppState().productHive.sortedList(keyOf: (e) => e.code, desc: false) : FFAppState().productHive.sortedList(keyOf: (e) => e.name, desc: false)).toList();
                                                                                    ...
                                                                                    return GridView.builder(
                                                                                      ...
                                                                                      itemBuilder: (context, productListIndex) {
                                                                                        ...
                                                                                        return Container(
                                                                                          ...
                                                                                          child: Stack(
                                                                                            children: [
                                                                                              if (!productAndListNewCopy2AppSettingsRecord!.settingList.where((e) => e.title == 'showProductImage').toList().firstOrNull!.value)
                                                                                                InkWell(
                                                                                                  splashColor: Colors.transparent,
                                                                                                  focusColor: Colors.transparent,
                                                                                                  hoverColor: Colors.transparent,
                                                                                                      ...
                                                                                                      if (productListItem.stock > 0) {
                                                                                                        if (FFAppState().prdid != productListItem.id) {
                                                                                                          ...
                                                                                                          _model.addtosavebill3 = await actions.addToHoldListprdCopy(
                                                                                                            ...
                                                                                                            functions.enabletaxinclusive(productAndListNewCopy2AppSettingsRecord!.settingList.where((e) => e.title == 'enableInclusiveTax').toList().firstOrNull!.value),
                                                                                                          );
                                                                                                          _shouldSetState = true;
                                                                                              ...
                                                                                              if (productAndListNewCopy2AppSettingsRecord?.settingList?.where((e) => e.title == 'showProductImage').toList()?.firstOrNull?.value ?? true)
                                                                                                InkWell(
                                                                                                  splashColor: Colors.transparent,
                                                                                                  focusColor: Colors.transparent,
                                                                                                  hoverColor: Colors.transparent,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              appsetting: productAndListNewCopy2AppSettingsRecord,
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      );
