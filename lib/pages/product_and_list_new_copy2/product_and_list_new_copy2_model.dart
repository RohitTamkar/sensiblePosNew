...
import '/index.dart';
import 'product_and_list_new_copy2_widget.dart'
...
class ProductAndListNewCopy2Model
    extends FlutterFlowModel<ProductAndListNewCopy2Widget> {
  ...
  // Stores action output result for [Custom Action - getProductlistHive] action in ProductAndListNewCopy2 widget.
  List<ProductStructStruct>? hiveProductList;
  // Stores action output result for [Custom Action - getCategorylistHive] action in ProductAndListNewCopy2 widget.
  List<CategoryStructStruct>? categoryListHive;
  // Stores action output result for [Custom Action - scanPrinter] action in ProductAndListNewCopy2 widget.
  bool? resDevice2Copy;
  // Stores action output result for [Custom Action - connectDevice] action in ProductAndListNewCopy2 widget.
  bool? isConnected;
  // Stores action output result for [Custom Action - filterProducts2] action in ProductAndListNewCopy2 widget.
  List<SelItemListStruct>? prdlinstnewtxCopy;
  // Stores action output result for [Firestore Query - Query a collection] action in ProductAndListNewCopy2 widget.
  AppSettingsRecord? appsetting;
  // Stores action output result for [Custom Action - oldbalanceplusamt] action in ProductAndListNewCopy2 widget.
  int? totalcreditCopy;
  // Stores action output result for [Custom Action - checkInternetConnection] action in ProductAndListNewCopy2 widget.
  bool? interprdCopy;
  // Stores action output result for [Backend Call - Create Document] action in ProductAndListNewCopy2 widget.
  InvoiceRecord? invonlineprtCopy;
  // Stores action output result for [Custom Action - addInvoiceBillhive] action in ProductAndListNewCopy2 widget.
  InvoiceStructStruct? hiveInvoiceDataCopy;
  // Stores action output result for [Custom Action - calShiftSummaryNew] action in ProductAndListNewCopy2 widget.
  dynamic? shiftSummarResultsNewCopy;
  // Stores action output result for [Firestore Query - Query a collection] action in ProductAndListNewCopy2 widget.
  ShiftRecord? shiftondataprintCopy;
  // Stores action output result for [Custom Action - hiveShiftCrud] action in ProductAndListNewCopy2 widget.
  ...
  // Stores action output result for [Custom Action - selectBillPrint] action in ProductAndListNewCopy2 widget.
  List<dynamic>? returnedList2Copy;
  // Stores action output result for [Custom Action - newCustomAction] action in ProductAndListNewCopy2 widget.
  List<dynamic>? deviceCopy;
  // Stores action output result for [Firestore Query - Query a collection] action in ProductAndListNewCopy2 widget.
  List<ServicePointOutletRecord>? spoutletCopy;
  // Stores action output result for [Firestore Query - Query a collection] action in ProductAndListNewCopy2 widget.
  ProductRecord? stockupdateprdprtCopy;
  // Stores action output result for [Custom Action - hivegetproductbyId] action in ProductAndListNewCopy2 widget.
  ProductStructStruct? itemprd2Copy;
  // Stores action output result for [Custom Action - hiveProductCrud] action in ProductAndListNewCopy2 widget.
