...
import 'full_screen_bill_model.dart';
export 'full_screen_bill_model.dart';
...
class _FullScreenBillWidgetState extends State<FullScreenBillWidget> {
  late FullScreenBillModel _model;
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Builder(
                              builder: (context) {
                                final bill = FFAppState().itemCartList.toList();
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<ProductRecord>
                                                  ...
                                                  snapshot.data!;
                                              if (gridViewProductRecordList
                                                  .isEmpty) {
                                                return Image.asset(
                                                  'assets/images/33740-sad-empty-box.gif',
                                                );
                                              }
