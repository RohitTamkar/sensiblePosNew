...
import 'ims_opening_stock_model.dart';
export 'ims_opening_stock_model.dart';
...
class _ImsOpeningStockWidgetState extends State<ImsOpeningStockWidget> {
  late ImsOpeningStockModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImsOpeningStockModel());
