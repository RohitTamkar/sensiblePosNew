...
class SearchHiveprdtable extends StatefulWidget {
  const SearchHiveprdtable({
    Key? key,
    this.width,
    this.height,
  ...
  final bool purchase;
  @override
  _SearchHiveprdtableState createState() => _SearchHiveprdtableState();
}

class _SearchHiveprdtableState extends State<SearchHiveprdtable> {
                        ...
                        if (selectedProduct.stockable) {
                          if (selectedProduct.stock > 0) {
                            if (FFAppState().prdid != selectedProduct.id) {
                              ...
                              _model.addtosavebill3 =
                                  await actions.addToHoldListprdtable(
                                      selectedProduct,
                                      FFAppState().selBill,
                                      widget!.taxcollection!.toList(),
                                      functions.enabletaxinclusive(widget
